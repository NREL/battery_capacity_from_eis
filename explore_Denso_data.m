...
annotation(gcf,'textbox',...
    ...
    'FontName','Arial',...
    'FontSize', 12);
exportgraphics(gcf, 'figures/data_fig2i.eps', 'Resolution', 600)
...
annotation(gcf,'textbox',...
    ...
    'FontName','Arial',...
    'FontSize', 12);
exportgraphics(gcf, 'figures/data_fig2j.eps', 'Resolution', 600)
...
annotation(gcf,'textbox',...
    ...
    'FontName','Arial',...
    'FontSize', 12);
exportgraphics(gcf, 'figures/data_fig2k.eps', 'Resolution', 600)
