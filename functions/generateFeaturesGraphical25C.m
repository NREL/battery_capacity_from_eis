function X_ = generateFeaturesGraphical25C(X, hyp)
%GENERATEFEATURESGRAPHICAL25C Graphical features for 25C data.
...
% feature 3: Z at f=10^2 Hz
idx3 = 26;
idx3 = [0:69:275] + idx3;
xout3 = x(:,idx3);

% feature 4: Z at f=10^0 Hz
idx4 = 46;
idx4 = [0:69:275] + idx4;
xout4 = x(:,idx4);
...
newVars = ["Zreal1","Zimag1","Zmag1","Zphz1",...
    ...
    "Zreal3","Zimag3","Zmag3","Zphz3",...
    "Zreal4","Zimag4","Zmag4","Zphz4",...
